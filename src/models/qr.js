    ...
    try {
        ...
        if (users.length > 0) {
            ...
            if (user.codigo_qr) {
                ...
                const qrUrl = `https://polizaqui.com/iniciar-compra/${cedula_rif}/${encodeURIComponent(nombre)}`; // Usar encodeURIComponent para asegurar caracteres válidos en la URL
